            ...
            for item in data:
                for key in item['metrics']:
                    if 'step' in item['tags']:
                        lines.append("system.cp.testdata.{};testId={};nodeId={};stepNumber={} {} {}".format(key, item['tags']['test_id'], item['tags']['node_id'], item['tags']['step'], item['metrics'][key], int(item['time_stamp'])))
                    elif 'hop_number' in item['tags']:
                        lines.append("system.cp.testdata.{};testId={};nodeId={};hopNumber={} {} {}".format(key, item['tags']['test_id'], item['tags']['node_id'], item['tags']['hop_number'], item['metrics'][key], int(item['time_stamp'])))
                    else:
                        lines.append("system.cp.testdata.{};testId={};nodeId={} {} {}".format(key, item['tags']['test_id'], item['tags']['node_id'], item['metrics'][key], int(item['time_stamp'])))
